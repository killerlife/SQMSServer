...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Sendmail_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 39, 28),
QT_MOC_LITERAL(6, 68, 11),
QT_MOC_LITERAL(7, 80, 13),
QT_MOC_LITERAL(8, 94, 28),
QT_MOC_LITERAL(9, 123, 11),
QT_MOC_LITERAL(10, 135, 12),
QT_MOC_LITERAL(11, 148, 9),
QT_MOC_LITERAL(12, 158, 9)
    },
    "Sendmail\0status\0\0finished\0stateChanged\0"
...
void Sendmail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->errorReceived((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        ...
        {
            typedef void (Sendmail::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Sendmail::status)) {
                *result = 0;
            }
        }
        {
            typedef void (Sendmail::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Sendmail::finished)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Sendmail::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Sendmail.data,
...
void *Sendmail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ISendmail"))
        return static_cast< ISendmail*>(const_cast< Sendmail*>(this));
...
// SIGNAL 0
void Sendmail::status(const QString & _t1)
{
